<html>
    ...
    <body>
      ...
      <div id="app">
            ...
            <h1 style="margin-top:0px;" id="demo">National level and below</h1>
      ...
      console.log( $( this ).serialize() );
            ...
            return axios.get(
              "https://api.airtable.com/v0/appTEADS2Hjk8M0Hk/national_and_below?view=Grid%20view&offset="+ offset,
          ...
          getData: function(app_id, app_key, data, offset) {
            ...
            if (offset === undefined){
              ...
              console.log(this.items[0]['fields']['Selection pool']);
            });
